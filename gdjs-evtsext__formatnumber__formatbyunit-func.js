...
let isConditionTrue_0 = false;
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = gdjs.evtTools.common.toString(gdjs.evtTools.common.floorTo(eventsFunctionContext.getArgument("Number"), eventsFunctionContext.getArgument("DecimalHouses"))); }}}
